...
class MutationBatch {
     ...
     * UserModel-provided mutations are applied both locally and remotely on the
     * backend.
     */
...
class SimpleDb {
    ...
    // visible for testing
    /** Parse UserModel Agent to determine iOS version. Returns -1 if not found. */
    ...
    // visible for testing
    /** Parse UserModel Agent to determine Android version. Returns -1 if not found. */
    ...
    async runTransaction(mode, objectStores, transactionFn) {
        ...
        while (true) {
            ...
            try {
                ...
                debug('Transaction failed with error: %s. Retrying: %s.', e.message, retryable);
                if (!retryable) {
...
/** UserModel-facing error when the primary lease is required but not available. */
        ...
        if (this.isPrimary &&
            ...
            await this.runTransaction('maybeGarbageCollectMultiClientState', 'readwrite-primary', txn => {
                ...
                return metadataStore.loadAll().next(existingClients => {
                    ...
                    return PersistencePromise.forEach(inactiveClients, (inactiveClient) => metadataStore.delete(inactiveClient.clientId));
                });
            });
...
class SyncEngine {
    ...
    sharedClientState, currentUser) {
        ...
        /** Stores user completion handlers, indexed by UserModel and BatchId. */
