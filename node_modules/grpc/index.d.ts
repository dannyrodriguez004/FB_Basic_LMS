...
declare module "grpc" {
  ...
  /**
   * UserModel-provided method to handle unary requests on a server
   */
  ...
  /**
   * UserModel provided method to handle client streaming methods on the server.
   */
  ...
  /**
   * UserModel provided method to handle server streaming methods on the server.
   */
  ...
  /**
   * UserModel provided method to handle bidirectional streaming calls on the server.
   */
