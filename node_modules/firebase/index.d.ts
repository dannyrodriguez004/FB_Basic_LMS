...
declare namespace firebase {
  ...
  interface User extends firebase.UserInfo {
     ...
     *     among your users, or is already linked to a Firebase UserModel.
     ...
     *   // The firebase.UserModel instance:
     ...
     *   // Profile updated successfully!
     *   // "Jane Q. UserModel", hasn't changed.
     *   var displayName = user.displayName;
     *   // Now, this is null.
     *   var photoURL = user.photoURL;
     * }, function(error) {
  ...
  /**
   * UserModel profile information, visible only to the Firebase project's
   * apps.
   *
   */
  interface UserInfo {
...
declare namespace firebase.auth {
  ...
  interface Auth {
     ...
     *
     * UserModel account creation can fail if the account already exists or the password
     * is invalid.
     *
     ...
     * returns a UserCredential with a null UserModel.
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     *   if (user) {
     *     // UserModel is signed in or token was refreshed.
     *   }
     * });
     * ```
     * @param
  ...
  class EmailAuthProvider extends EmailAuthProvider_Instance {
     ...
     * @param password UserModel account password.
  ...
  /**
   * A structure containing a UserModel, an AuthCredential, the operationType, and
...
declare namespace firebase.database {
  ...
  interface Reference extends firebase.database.Query {
     ...
     *   } else {
     *     console.log('UserModel ada already exists.');
     ...
     *   } else {
     *     console.log('UserModel ada added!');
     *   }
